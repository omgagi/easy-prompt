...
4. Tap the timer menu on the right to choose **Off**, **5 seconds**, or **10 seconds**. Tap the red button to start the countdown; tap it again to cancel. Recording and voice following begin after the countdown, including when you resume a take. Tap the red button while recording to pause, then tap it to resume. The red progress bar fills in 2½-minute sections, with no timer labels. Thin white marks separate takes. It stops during pauses and goes back when you undo a take. Status, **Mic OK**, and **Voice OK** appear below the record button.
5. Tap **Preview** to play the current takes full screen in the app. If recording, Preview first pauses the take. Tap the video to pause or resume playback; tap **X** to return to the teleprompter without finishing. While paused, tap the left arrow to undo the last take and the right arrow to restore it. Recording a new take discards the undone take. Tap the checkmark to join the remaining takes into one portrait video. The video is saved to Photos when permission is granted; tap **Share** to send it elsewhere.
